...
; Put object code into the NOR-flash EEPROM on main board
; Install IO-Board, flash eeprom with some user code
; Below code copies IO-board serial EEPROM into RAM and executes user code
