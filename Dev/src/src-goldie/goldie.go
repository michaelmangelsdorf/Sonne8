...
var symTab = []symbol{
	...
	/*PAIR*/
	{0x80, "no"}, {0x81, "END"}, {0x82, "SCROUNGE_NL"}, {0x83, "nd"}, {0x84, "nr"}, {0x85, "ni"}, {0x86, "ns"}, {0x87, "np"}, {0x88, "ne"}, {0x89, "na"}, {0x8A, "nb"}, {0x8B, "nj"}, {0x8C, "nw"}, {0x8D, "nt"}, {0x8E, "nf"}, {0x8F, "nc"},
	{0x90, "mo"}, {0x91, "SCROUNGE_MM"}, {0x92, "SCROUNGE_ML"}, {0x93, "md"}, {0x94, "mr"}, {0x95, "mi"}, {0x96, "ms"}, {0x97, "mp"}, {0x98, "me"}, {0x99, "ma"}, {0x9A, "mb"}, {0x9B, "mj"}, {0x9C, "mw"}, {0x9D, "mt"}, {0x9E, "mf"}, {0x9F, "mc"},
	{0xA0, "lo"}, {0xA1, "SCROUNGE_LM"}, {0xA2, "SCROUNGE_LL"}, {0xA3, "ld"}, {0xA4, "lr"}, {0xA5, "li"}, {0xA6, "ls"}, {0xA7, "lp"}, {0xA8, "le"}, {0xA9, "la"}, {0xAA, "lb"}, {0xAB, "lj"}, {0xAC, "lw"}, {0xAD, "lt"}, {0xAE, "lf"}, {0xAF, "lc"},
	{0xB0, "do"}, {0xB1, "dm"}, {0xB2, "dl"}, {0xB3, "SCROUNGE_DD"}, {0xB4, "dr"}, {0xB5, "di"}, {0xB6, "ds"}, {0xB7, "dp"}, {0xB8, "de"}, {0xB9, "da"}, {0xBA, "db"}, {0xBB, "dj"}, {0xBC, "dw"}, {0xBD, "dt"}, {0xBE, "df"}, {0xBF, "dc"},
	{0xC0, "ro"}, {0xC1, "rm"}, {0xC2, "rl"}, {0xC3, "rd"}, {0xC4, "SCROUNGE_RR"}, {0xC5, "ri"}, {0xC6, "rs"}, {0xC7, "rp"}, {0xC8, "re"}, {0xC9, "ra"}, {0xCA, "rb"}, {0xCB, "rj"}, {0xCC, "rw"}, {0xCD, "rt"}, {0xCE, "rf"}, {0xCF, "rc"},
	{0xD0, "io"}, {0xD1, "im"}, {0xD2, "il"}, {0xD3, "id"}, {0xD4, "ir"}, {0xD5, "SCROUNGE_II"}, {0xD6, "is"}, {0xD7, "ip"}, {0xD8, "ie"}, {0xD9, "ia"}, {0xDA, "ib"}, {0xDB, "ij"}, {0xDC, "iw"}, {0xDD, "it"}, {0xDE, "if"}, {0xDF, "ic"},
